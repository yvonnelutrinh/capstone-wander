const soundEffects = {
    "windChimesMedium": { src: "/src/assets/audio/koshi-wind-chimes-medium.mp3", volume: 0.7 },
...
const music = {
    ...
    "whimsical": { src: "/src/assets/audio/whimsical.mp3", volume: 0.8 },
    "end": { src: "/src/assets/audio/end.mp3", volume: 0.3 }
}
